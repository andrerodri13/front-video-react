...
export const handlers = [
    ...
    rest.delete(`${baseUrl}/categories/cbdd550c-ad46-4e50-be8d-a8266aff4162`, (_, res, ctx) => {
...
describe("CategoryList", () => {
    ...
    it('should render on page change', async () => {
        renderWithProviders(<CategoryList/>);
        await waitFor(() => {
            const name = screen.getByText("PaleTurquoise");
            expect(name).toBeInTheDocument();
    ...
    it('should handle filter change', async () => {
        ...
        // pegar input com o placeholder Search
        const input = screen.getByPlaceholderText("Search…");

        //Fire event on change
        fireEvent.change(input, {
            target: {value: "PapayaWhip"},
        });
